...
function handleExportDeclaration(exportDeclaration) {
    if (exportDeclaration.exportClause) {
        ...
        if (ts.isStringLiteral(exportDeclaration.moduleSpecifier)) {
            var stringLiteral = exportDeclaration.moduleSpecifier;
            var currentSourceFile = store_1.default.instance.getCurrentSourceFile();
...
exports.default = handleExportDeclaration;
